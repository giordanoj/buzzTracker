    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        inventoryBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                inventory.putExtra("location", Model.getInstance().getCurrentUser().get_Location().get_id() + "");
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (result.startsWith("no items found")) {
                ...
                while (result.trim().length() > 1) {
                    ...
                    Item item = new Item(category, donationTime, value, picture, comments, name, description, origin, saleTime, enteredBy, soldBy, currentLocation);
                    items.add(item);
                }
